...
const translations = {
  en: {
    ...
    ai_videos: "AI videos",
    ai_videos_intro: "Original AI-driven films and social promos, created from concept through final delivery.",
    show_more_ai_videos: "Show 2 more videos",
    show_fewer_ai_videos: "Show fewer videos",
  ...
  de: {
    ...
    ai_videos: "AI-Videos",
    ai_videos_intro: "Originelle KI-gestützte Filme und Social-Media-Promos – vom Konzept bis zur finalen Umsetzung.",
    show_more_ai_videos: "2 weitere Videos anzeigen",
    show_fewer_ai_videos: "Weniger Videos anzeigen",
